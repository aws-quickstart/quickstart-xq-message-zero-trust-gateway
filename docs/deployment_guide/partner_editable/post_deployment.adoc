...
image::../images/postdeploy1.png[Postdeployment]
...
[#postdeploy2]
.Quick Start post-deployment for {partner-product-short-name} on AWS
image::../images/postdeploy2.png[Postdeployment]
...
[#postdeploy3]
.Quick Start post-deployment for {partner-product-short-name} on AWS
image::../images/postdeploy3.png[Postdeployment]
...
[#postdeploy4]
.Quick Start post-deployment for {partner-product-short-name} on AWS
image::../images/postdeploy4.png[Postdeployment]
...
[#postdeploy5]
.Quick Start post-deployment for {partner-product-short-name} on AWS
image::../images/postdeploy5.png[Predeployment]
